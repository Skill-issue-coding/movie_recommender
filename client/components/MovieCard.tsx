  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem
        ...
        <AccordionTrigger className="gradient-card rounded-xl border border-border px-5 pt-7 pb-2 hover:border-primary/50 transition-all duration-300 hover:glow-primary animate-slide-up">
